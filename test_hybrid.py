...
print(oh.nesterov.accer(obf, [x1, x2], (2.0, 3.0), verbose=True, proxim='ln', epsilon=4.00501))
# print(oh.fista.decline(obf, [x1, x2], (2.0, 3.0), verbose=True, proxim='ln', epsilon=4.00501))
